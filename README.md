...
These calculations assume certain numbers for calculation simplicity, however, specifically to Australia the average internet speed as of last year was ~67mbps. This means in 0.7ms, about 4 packets with an average size of 1500 bytes will be sent. The models inference speed at ~0.7ms per 100 packets will be more than sufficient with significant breathing space.
